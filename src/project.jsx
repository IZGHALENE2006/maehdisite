    ...
    <div className="bg-[#0B0B0B] py-20 px-10 relative">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative mb-16">
          {/* العنوان في الوسط تماماً */}
          <h1 className="text-center font-bold text-4xl text-[#A1A1A1]">
            <span className="text-[#FF8C1A]">My </span>Project
          </h1>

          {/* الأسهم - درتهم absolute باش مياثروش على الـ Center ديال العنوان */}
          <div className="flex gap-4 absolute right-0 bottom-0">
            <button onClick={() => scroll('left')} className="p-3 border border-[#1f1f1f] rounded-full text-white hover:bg-[#FF8C1A] hover:border-[#FF8C1A] transition-all">
            ...
            <button onClick={() => scroll('right')} className="p-3 border border-[#1f1f1f] rounded-full text-white hover:bg-[#FF8C1A] hover:border-[#FF8C1A] transition-all">
